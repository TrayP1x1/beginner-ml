...
2. Build the solution in your IDE as a normal Python project.
3. Run the file from the terminal instead of only inside a notebook.
4. Add one small test or error check whenever possible.
5. Keep your final version runnable from `main()`.

Why Week 4 matters:

- It makes your code easier to explain in an interview or test.
